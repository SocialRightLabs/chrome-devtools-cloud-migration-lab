...
| 07 | `module-07-appengine-push-tasks` | Next | Official Google codelab / research planning | Add App Engine Push Task Queues as prerequisite for Module 08 Cloud Tasks | Network, Console, Cloud Logging | App Engine, Task Queue push queues | Medium | `docs/modules/module-07-appengine-push-tasks/` | Push Task Queue baseline before Cloud Tasks migration | Needs manual review |
