...
| 03 | `module-03-cloud-tasks` | Next | Research candidate | Async task migration demo | Network, Console | Cloud Tasks, App Engine | Medium | TBD | Queue migration pattern | Needs manual review |
...
| 08 | `module-08-lighthouse-performance` | Next | Research candidate | Lighthouse and performance improvement report | Lighthouse, Performance, Network | Optional hosting | Low | TBD | Web quality audit | Allowed public-safe documentation/checklist pattern |
